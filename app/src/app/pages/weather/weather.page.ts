...
export class WeatherPage implements OnInit {
  public news: WeatherAlertGetDto[] = [];
  ...
  public searchResult: WeatherAlertGetDto[] = [];
  public limitedSearchResult: WeatherAlertGetDto[] = [];
  ...
  private setNews(): void {
    ...
    this.weatherService.getWeatherAlerts().subscribe({
      next: (res) => {
        this.news = res.map(n => {
